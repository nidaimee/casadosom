...
Discount.create name: 'Desconto natal', description: 'Aplique esse desconto no natal', value: '10', kind: :porcent, status: :active
Discount.create name: 'Desconto natal', description: 'Aplique esse desconto no natal', value: '10', kind: :money, status: :active
